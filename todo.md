...
- [ ] **Top Scorers Leaderboard**: Implement a background task to continuously analyze and maintain a leaderboard of the week's top-scoring stocks. For now, this should be restricted to Indian stocks only.
